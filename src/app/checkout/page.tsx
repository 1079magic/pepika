  ...
  if (items.length === 0) {
    return (
      <div className="text-center py-24">
        ...
        <p className="text-sage-500 mb-6">Add some products before checking out.</p>
  ...
  return (
    <section className="bg-cream min-h-screen">
      <div className="container max-w-7xl mx-auto px-4 py-8">
        <Link href="/shop" className="inline-flex items-center gap-2 text-sm text-sage-500 hover:text-brand-600 transition-colors mb-8">
          <ArrowLeft className="w-4 h-4" /> Continue Shopping
        </Link>

        <h1 className="font-display text-3xl font-bold text-charcoal mb-8">Checkout</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="email" placeholder="your@email.com" className="w-full px-4 py-2.5 rounded-lg border border-sage-200 outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h2 className="font-display text-lg font-semibold text-charcoal mb-4 flex items-center gap-2">
                <Truck className="w-5 h-5 text-sage-500" /> Shipping Address
              </h2>
              <div className="space-y-4">
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-1.5">Postcode</label>
                    <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-sage-200 outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all" />
                  </div>
                  <div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h2 className="font-display text-lg font-semibold text-charcoal mb-4 flex items-center gap-2">
                <CreditCard className="w-5 h-5 text-sage-500" /> Payment
              </h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-charcoal mb-1.5">Card Number</label>
                  <input type="text" placeholder="1234 5678 9012 3456" className="w-full px-4 py-2.5 rounded-lg border border-sage-200 outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-1.5">Expiry Date</label>
                    <input type="text" placeholder="MM/YY" className="w-full px-4 py-2.5 rounded-lg border border-sage-200 outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-charcoal mb-1.5">CVC</label>
                    <input type="text" placeholder="123" className="w-full px-4 py-2.5 rounded-lg border border-sage-200 outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 transition-all" />
                  </div>
                </div>
              </div>
              <p className="flex items-center gap-2 text-xs text-sage-400 mt-4">
          ...
          <div>
            <div className="bg-white rounded-xl p-6 shadow-sm sticky top-24">
              ...
              <div className="divide-y divide-sage-100">
                {items.map(item => (
                  <div key={item.product.id} className="flex gap-3 py-3">
                    <div className="w-14 h-14 rounded-lg overflow-hidden bg-sage-50 shrink-0 relative">
              ...
              <div className="border-t border-sage-100 mt-3 pt-3 space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-sage-500">Subtotal ({itemCount} items)</span>
                ...
                <div className="flex justify-between text-base font-bold border-t border-sage-100 pt-3 mt-3">
